    ...
    <form class="col s12" method="post">
      <div class="row">
        <div class="input-field col s12">
          <input id="input_text" type="text" name="titulo" data-length="10">
          <label for="input_text">Título</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
          <textarea id="textarea2" class="materialize-textarea" name="descricao" data-length="250"></textarea>
      ...
      <div class="row">
        ...
        <label>
          <input class="with-gap col s6" name="ativo" value="n" type="radio" />
          <span>Inativo</span>
        </label>
      </div>
